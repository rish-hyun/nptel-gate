...
class Nptel:
    ...
    def get_departments():
        ...
        return {
            tag.img['alt']: {
                'branchID': tag.a['href'].split('?')[1].split('&')[0].split('=')[1],
                'cid': tag.a['href'].split('?')[1].split('&')[1].split('=')[1]
    ...
    def get_topics(value, branchID, cid):
    ...
    def get_sub_topics(topic, value, branchID, cid):
